...
import postre2 from '../img/postre2.png'
import postre3 from '../img/postre3.png'
import postre4 from '../img/postre4.png'
    ...
    return (
      <div>
          ...
          <div className='flex'>
              <div className='cartas mt-10 ml-10 rounded-lg'>
                  <div className='relative'> 
                      <img className='absolute h-32' src={chocolate} alt="" />
                      <img className='absolute ml-32 bg-gray-700 border-gray-700 rounded-md mt-1' src={like} alt="" />
                  </div>
                  <div className='relative'>
                  <h3 className='absolute mt-36 ml-2'><strong>Chocolate Cake</strong></h3>
                      <div className='flex'>
              ...
              <div className='cartas mt-10 ml-10 rounded-lg'>
                  <div className='relative'> 
                      <img className='absolute h-32 w-44' src={postre2} alt="" />
                      <img className='absolute ml-28 bg-gray-700 border-gray-700 rounded-md mt-2 mr-1' src={like} alt="" />
                  </div>
                  <div className='relative'>
                  <h3 className='absolute mt-36 ml-2'><strong>Strawberry Treat</strong></h3>
                      <div className='flex'>
          ...
          <div className='flex'>
              <div className='cartas mt-10 ml-10 rounded-lg'>
                  <div className='relative'> 
                      <img className='absolute h-32' src={postre3} alt="" />
                      <img className='absolute ml-32 bg-gray-700 border-gray-700 rounded-md mt-1' src={like} alt="" />
                  </div>
                  <div className='relative'>
                  <h3 className='absolute mt-36 ml-2'><strong>Danash</strong></h3>
                      <div className='flex'>
              ...
              <div className='cartas mt-10 ml-10 rounded-lg'>
                  <div className='relative'> 
                      <img className='absolute h-32 w-44' src={postre4} alt="" />
                      <img className='absolute ml-28 bg-gray-700 border-gray-700 rounded-md mt-2 mr-1' src={like} alt="" />
                  </div>
                  <div className='relative'>
                  <h3 className='absolute mt-36 ml-2'><strong>Cookies</strong></h3>
                      <div className='flex'>
                          <h3 className='absolute mt-44 text-green-700 ml-2'><strong>Rp 2,000</strong></h3>
                          <h5 className='absolute mt-[178px] ml-[89px] text-gray-400 text-xs '>/kg</h5>
                      </div>
                  <h5 className='line-through absolute mt-[200px] text-[12px] text-gray-400 ml-2'>Rp 4,000</h5>
                  <img className='absolute mt-[218px] ml-[120px]' src={mas} alt="" />
                  </div>
              </div>
          </div>
